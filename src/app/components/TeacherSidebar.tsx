  ...
  return (
    <aside className="w-64 bg-sidebar-bg min-h-screen flex flex-col fixed left-0 top-0 bottom-0 z-30">
      <div className="px-6 py-5 border-b border-white/10">
        <Logo light size="md" />
        <p className="text-xs text-indigo-300 mt-1 tracking-wide">
          Teacher Portal
        </p>
      </div>
      ...
      <div className="px-3 pb-3 space-y-1">
        ...
        <button className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-sidebar-text hover:bg-white/8 hover:text-white transition-all w-full">
          <LogOut size={18} />
          Sign Out
        </button>
      </div>
      ...
      <div className="px-4 py-4 border-t border-white/10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-medium text-white">Ms. Sarah Chen</p>
            <p className="text-xs text-indigo-300">AP Biology</p>
          </div>
        </div>
      </div>
    </aside>
